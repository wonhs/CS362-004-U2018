...
int mineEffect(int i, int j, int currentPlayer, int choice1, int choice2, struct gameState* state, int handPos){
...
int feastEffect(int i, int currentPlayer, int* temphand, int x, int choice1, struct gameState* state){
...
int council_roomEffect(int i, int currentPlayer, int handPos, struct gameState* state){
    //+4 Cards
    for (i = 0; i < 4; i++)
	{
	  drawCard(currentPlayer, state);
...
int cardEffect(int card, int choice1, int choice2, int choice3, struct gameState *state, int handPos, int *bonus)
{
  ...
  switch( card ) 
	...
	case smithy:
	    smithyEffect(state, currentPlayer, handPos, i);
        return 0;
		
    case mine:
	    mineEffect(i, j, currentPlayer, choice1, choice2, state, handPos);
        return 0;
		
	case feast:
	    feastEffect( i, currentPlayer, temphand, x, choice1, state);
        return 0;	  
		
    case council_room:
		council_roomEffect( i, currentPlayer, handPos, state);			
		return 0;
